...
import { ChevronRight, Gift, Star, PenTool, Zap, FileText, Clock } from "lucide-react"
            ...
            <div className="mb-6">
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>{userData.currentExp} / {userData.nextLevelExp} XP ({expPercentage}%)</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
        ...
        <TabsContent value="current-rewards" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Level {userData.level} - {currentLevelDetails?.name}</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {levelRewards
                  ...
                  .map((reward) => (
                    <div key={reward.level} className="border rounded-lg p-4">
                      <div className="flex items-center  className="border rounded-lg p-4\">
              ...
              {userData.level < 10 && (
                <div className="mt-6 p-4 border border-dashed rounded-lg bg-muted/30">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Reach level {userData.level + 1} to unlock:
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-3">
